...
CHitScan::CHitScan(Mesh* _modelMesh)
...
void CHitScan::SetLength(const float m_fLength)
{
	this->m_fLength = m_fLength;
}

// Get the length of the laser
float CHitScan::GetLength(void) const
{
	return m_fLength;
}

// Update this laser
void CHitScan::CalculateAngles(void)
{
...
void CHitScan::Update(double dt)
{
	if (m_bStatus == false)
		return;
...
CHitScan* Create::HitScan(const std::string& _meshName,
